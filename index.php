...
<head>
    ...
    <script>
        function auth_popup( provider ){
           ...
           var authWindow = window.open('http://localhost/hybridauth/hybridauth-3.2.0/examples/example_07/callback.php?provider='+provider, 'authWindow', 'width=600,height=400,scrollbars=yes');
            return false;
        }
    </script>
